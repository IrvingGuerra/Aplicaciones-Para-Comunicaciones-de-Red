...
|                   */
                ...
                if (line.indexOf("?") == -1) {
                    ...
                    if (FileName.compareTo("") == 0) {
                        ...
                        if (line.toUpperCase().startsWith("DELETE")) {
                            ...
                            Checktype(FileName);
                            System.out.println(eliminated_file.getName());
                            String sb = "";
    ...
    public PracticaServidor() throws Exception {
        ExecutorService es = Executors.newFixedThreadPool(10);
        for (;;) {
            System.out.println("Esperando por el cliente...");
            Socket accept = ss.accept();
            es.submit(new Manejador(accept));
            System.out.println("Hilos en alberca: " + ((ThreadPoolExecutor) es).getPoolSize());
        }
    }

    public static void main(String[] args) throws Exception {
        PracticaServidor sWEB = new PracticaServidor();
    }
